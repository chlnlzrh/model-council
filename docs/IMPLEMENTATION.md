...
| `lib/council/modes/decompose.ts` | Multi-Mode | **Done** |
| `lib/council/modes/brainstorm.ts` | Multi-Mode | **Done** |
| `lib/council/modes/fact-check.ts` | Multi-Mode | **Done** |
| `__tests__/decompose-mode.test.ts` | Multi-Mode | **Done** |
| `__tests__/brainstorm-mode.test.ts` | Multi-Mode | **Done** |
| `__tests__/fact-check-mode.test.ts` | Multi-Mode | **Done** |
| `__tests__/analytics-mode-compute.test.ts` | Analytics | **Done** |
| `lib/analytics/mode-compute.ts` | Analytics | **Done** |
| `components/analytics/daily-usage-chart.tsx` | Analytics | **Done** |
| `components/analytics/mode-distribution-chart.tsx` | Analytics | **Done** |
| `components/analytics/mode-selector.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics-panel.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/competitive-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/scoring-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/convergence-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/sequential-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/creative-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/adversarial-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/verification-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/specialist-metrics.tsx` | Analytics | **Done** |
| `components/analytics/mode-metrics/generic-metrics.tsx` | Analytics | **Done** |
| `components/analytics/model-leaderboard.tsx` | Analytics | **Done** |
| `components/analytics/model-mode-heatmap.tsx` | Analytics | **Done** |
